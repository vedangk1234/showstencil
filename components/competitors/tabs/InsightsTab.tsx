...
export function InsightsTab({ competitor, plan }: InsightsTabProps) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 11, color: '#333333', marginTop: 16, fontFamily: 'monospace', lineHeight: 1.5 }}>
        Generated by Claude · Based on publicly available data.
        Scores and estimates are calculated by ShowStencil from YouTube API data
        and are not YouTube metrics.
      </p>
    </div>
  )
}
